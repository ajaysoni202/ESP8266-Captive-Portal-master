...
String postedSSID() {
  ...
  // Change SSID of the WiFi network
  WiFi.softAP(postedSSID);
  
  // Return a response to the client
  return header("SSID Updated") + "<div><p>SSID has been updated to: " + postedSSID + "</p></div><center><a style=\"color:blue\" href=/>Back to Index</a></center>" + footer();
}
